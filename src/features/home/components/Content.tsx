      ...
      <section className={styles.content}>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.title}>
            ...
            <p>
              Kết nối người dân/hộ gia đình có rác tái chế với người thu gom và các đơn vị
              tái chế một cách tiện lợi và hiệu quả thông qua nền tảng công nghệ.
            </p>
          </div>
            ...
            <div className={styles.missionList}>
              ...
              <div className={styles.missionItem}>
                <div className={styles.missionItemContent}>
                  ...
                  <p>
                    Thúc đẩy phân loại rác tại nguồn và tăng tỷ lệ tái chế, giảm thiểu
                    lượng rác thải ra môi trường, góp phần bảo vệ môi trường.
                  </p>
                </div>
              ...
              <div className={styles.missionItem}>
                <div className={styles.missionItemContent}>
                  ...
                  <p>
                    Tạo thêm nguồn thu nhập cho người thu gom và tối ưu hóa chuỗi cung ứng
                    rác tái chế.
                  </p>
                </div>
              ...
              <div className={styles.missionItem}>
                <div className={styles.missionItemContent}>
                  ...
                  <p>
                    Xây dựng một cộng đồng có ý thức về tái chế và tiêu dùng bền vững.
                  </p>
              ...
              <div className={styles.missionItem}>
                <div className={styles.missionItemContent}>
                  ...
                  <p>
                    Ứng dụng công nghệ để minh bạch hóa và nâng cao hiệu quả của ngành
                    công nghiệp tái chế.
                  </p>
                </div>
      ...
      <section className={styles.needContent}>
        ...
        <div className={styles.needContainer}>
          ...
          <div className={styles.needTitle}>
            ...
            <p>
              Hiện nay, rác tái chế (nhựa, giấy, kim loại...) bị bỏ phí rất lớn vì không
              được thu gom đúng cách. Đồng thời, người dân chưa có động lực thực sự để
              nhặt và phân loại rác.
            </p>
          </div>
